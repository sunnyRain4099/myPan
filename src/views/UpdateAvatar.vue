...
const submitForm = async () => {
  ...
  dialogConfig.value.show = false
  const cookeUserInfo = localStorage.getItem('userInfo')
  ...
  const userInfo = JSON.parse(cookeUserInfo)
  userInfo.avatar = result.avatar // 更新头像信息
  localStorage.setItem('userInfo', JSON.stringify(userInfo))
  authStore.setUserInfo(userInfo) // 更新 Pinia 中的用户信息
  //更新cookie信息
  emit('updateAvatar')
}
</script>
